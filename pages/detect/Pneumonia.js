...
export default function Pneumonia() {
    ...
    const handleSubmit = async event => {
        try {
            const res = await axios.post('http://65.0.120.185/api/v1/predict/covid', bodyFormData, {
                headers: {
            ...
            console.log(e);
            setResponse("You have Pneumonia");
        }
    }
    return (
        <div>
            ...
            <div className="rounded-t bg-white mb-0 px-12 py-6">
                <div className="text-center flex justify-between">
                    <h6 className="text-blueGray-700 text-xl font-bold">Covid Pneumonia Detection</h6>
                    <Link href="/">
                        <button
